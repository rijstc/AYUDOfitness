...
public class UUIDList {
    ...
    public static UUID SERVICE_HEART_RATE = UUID.fromString(String.format(BASE_UUID, "180d"));
    public static UUID SERVICE_DEVICE_INFO = UUID.fromString(String.format(BASE_UUID, "180a"));
    ...
    public static UUID DESCRIPTOR_HEART_RATE = UUID.fromString("00002902-0000-1000-8000-00805f9b34fb");
